...
/* Define window size */
#define W2 300 // width of screen
#define H 200  // height of screen
#define W 200  // width of _game_ screen (in SplitScreen mode, map is drawn in the remaining space)
...
// *********** Enable/Disable advanced functions - not all supported without SDL
...
//static SDL_Surface* surface = NULL;   //TODO: This has to be replaced.
/*
